                ...
                <div className="serviceSection">
                    <div className="serviceLeft">
                        ...
                        <div className="serviceBlock">
                            ...
                            <h3 className="trimList">1. Remove competing leader</h3>
                            ...
                            <h3 className="trimList">2. Remove crowded, malformed or crossing branches</h3>
                            ...
                            <h3 className="trimList">3. Remove disease, damaged or dead branches</h3>
                            ...
                            <h3 className="trimList">4. Remove low branches, suckers or grinding roots</h3>
